...
filename_ncbi_list = 'NcbiMrnaXenbaseGene_tropicalis.txt'
filename_ncbi_fa = 'xtropMRNA.fasta'

## clean up version of UniGene sequence. 
## See https://github.com/marcottelab/omics/tree/master/unigene
filename_unigene_fa = '/work/xenopus/ref.XENTR/UG52/XENTR_UG52_uniq.fa'

filename_unigene_list = 'GenePageTropicalisEntrezGeneUnigeneMapping.txt'
filename_nomodel_list = 'TropicalisGenePages_NoModel.txt'

filename_out = 'XENTR_xb201405_mrna.fa'
